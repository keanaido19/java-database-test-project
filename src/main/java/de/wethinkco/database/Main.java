...
import de.wethinkco.database.dbconnect.StaticSQLiteConnector;
...
//        World world = new World(worldData, List.of(obstacle, obstacle,
//                obstacle, obstacle, new WorldObject(1, 1, 23, 55)));
...
////        sqliteConnector.lol();
        StaticSQLiteConnector staticSQLiteConnector =
                new StaticSQLiteConnector("testdb.db");
//        staticSQLiteConnector.saveWorld();
//        staticSQLiteConnector.restoreWorld("3");
    }
}
